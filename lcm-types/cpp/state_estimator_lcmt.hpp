...
int state_estimator_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->pFoot[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int state_estimator_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->pFoot[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
{
    uint64_t hash = 0xac5123ab33fb45a4LL;
