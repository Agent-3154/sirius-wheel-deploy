...
class wbc_test_data_lcmt
{
    public:
        ...
        float      ori_task_error[3];

        float      pos_task_error[3];

        float      link_pos_task_error[4][3];
...
int wbc_test_data_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->contact_esi[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->ori_task_error[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->pos_task_error[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->link_pos_task_error[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->body_angl_vel[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->opt_result[0], 18);
    if(tlen < 0) return tlen; else pos += tlen;
...
int wbc_test_data_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->contact_esi[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->ori_task_error[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->pos_task_error[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < 4; a0++) {
        tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->link_pos_task_error[a0][0], 3);
        if(tlen < 0) return tlen; else pos += tlen;
    }
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->body_angl_vel[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->opt_result[0], 18);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x25c78209a6542039LL;
