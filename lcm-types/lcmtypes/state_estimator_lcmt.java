...
public final class state_estimator_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xac5123ab33fb45a4L;
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.pFoot = new float[(int) 4][(int) 3];
        for (int a = 0; a < 4; a++) {
            for (int b = 0; b < 3; b++) {
    ...
    public lcmtypes.state_estimator_lcmt copy()
    {
        ...
        outobj.pFoot = new float[(int) 4][(int) 3];
        for (int a = 0; a < 4; a++) {
            System.arraycopy(this.pFoot[a], 0, outobj.pFoot[a], 0, 3);        }
