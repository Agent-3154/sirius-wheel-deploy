...
public final class ros_lowcmd_lcmt implements lcm.lcm.LCMEncodable
{
    public float tau_ff[];
    public float q_des[];
    public float qd_des[];
    ...
    {
        if (classes.contains(lcmtypes.ros_lowcmd_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.ros_lowcmd_lcmt.class);
    ...
    public ros_lowcmd_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public ros_lowcmd_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.ros_lowcmd_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.ros_lowcmd_lcmt o = new lcmtypes.ros_lowcmd_lcmt();
    ...
    public lcmtypes.ros_lowcmd_lcmt copy()
    {
        lcmtypes.ros_lowcmd_lcmt outobj = new lcmtypes.ros_lowcmd_lcmt();
