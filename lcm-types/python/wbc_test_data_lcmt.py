...
class wbc_test_data_lcmt(object):
    __slots__ = ["Fr_des", "Fr", "contact_esi", "ori_task_error", "pos_task_error", "link_pos_task_error", "body_ori_cmd", "body_pos_cmd", "body_vel_cmd", "body_ang_vel_cmd", "body_rpy_cmd", "body_pos", "body_vel", "body_ori", "body_angl_vel", "body_rpy", "foot_pos_cmd", "foot_vel_cmd", "foot_acc_cmd", "foot_pos", "foot_vel", "jpos_cmd", "jvel_cmd", "jacc_cmd", "tau_ff", "opt_result"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[12], [12], [4], [3], [3], [4, 3], [4], [3], [3], [3], [3], [3], [3], [4], [3], [3], [12], [12], [12], [12], [12], [12], [12], [12], [12], [18]]

    def __init__(self):
        self.Fr_des = [ 0.0 for dim0 in range(12) ]
        self.Fr = [ 0.0 for dim0 in range(12) ]
        self.contact_esi = [ 0.0 for dim0 in range(4) ]
        self.ori_task_error = [ 0.0 for dim0 in range(3) ]
        self.pos_task_error = [ 0.0 for dim0 in range(3) ]
        self.link_pos_task_error = [ [ 0.0 for dim1 in range(3) ] for dim0 in range(4) ]
        ...
        self.body_angl_vel = [ 0.0 for dim0 in range(3) ]
        ...
        self.opt_result = [ 0.0 for dim0 in range(18) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>4f', *self.contact_esi[:4]))
        buf.write(struct.pack('>3f', *self.ori_task_error[:3]))
        buf.write(struct.pack('>3f', *self.pos_task_error[:3]))
        for i0 in range(4):
            buf.write(struct.pack('>3f', *self.link_pos_task_error[i0][:3]))
        ...
        buf.write(struct.pack('>3f', *self.body_angl_vel[:3]))
        ...
        buf.write(struct.pack('>18f', *self.opt_result[:18]))
    ...
    def _decode_one(buf):
        ...
        self.contact_esi = struct.unpack('>4f', buf.read(16))
        self.ori_task_error = struct.unpack('>3f', buf.read(12))
        self.pos_task_error = struct.unpack('>3f', buf.read(12))
        self.link_pos_task_error = []
        for i0 in range(4):
            self.link_pos_task_error.append(struct.unpack('>3f', buf.read(12)))
        ...
        self.body_angl_vel = struct.unpack('>3f', buf.read(12))
        ...
        self.opt_result = struct.unpack('>18f', buf.read(72))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if wbc_test_data_lcmt in parents: return 0
        tmphash = (0x25c78209a6542039) & 0xffffffffffffffff
