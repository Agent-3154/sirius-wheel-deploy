...
class state_estimator_lcmt(object):
    __slots__ = ["p", "vWorld", "vBody", "vRemoter", "rpy", "omegaBody", "omegaWorld", "quat", "aBody", "aWorld", "pFoot"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[3], [3], [3], [3], [3], [3], [3], [4], [3], [3], [4, 3]]
    ...
    def __init__(self):
        ...
        self.pFoot = [ [ 0.0 for dim1 in range(3) ] for dim0 in range(4) ]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(4):
            buf.write(struct.pack('>3f', *self.pFoot[i0][:3]))
    ...
    def _decode_one(buf):
        ...
        self.pFoot = []
        for i0 in range(4):
            self.pFoot.append(struct.unpack('>3f', buf.read(12)))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if state_estimator_lcmt in parents: return 0
        tmphash = (0xac5123ab33fb45a4) & 0xffffffffffffffff
