...
void FSM_State_RL_Walk_2::run_state() {
    ...
    desired_vel_xyw_command << fsm_data_->rc_->rc_control_.v_des[0]*0.7, fsm_data_->rc_->rc_control_.v_des[1]*0.3, fsm_data_->rc_->rc_control_.v_des[2]*0.8;
    ...
    for (auto &leg: this->fsm_data_->leg_controller_->leg_command) {
        ...
        leg.kd_joint = Vec3<double>(2.5, 2.5, 2.5).asDiagonal();
